# Scanbot Barcode Scanner SDK Use Cases Example App for iOS

This example app shows how to integrate the [Scanbot Barcode Scanner SDK for iOS](https://scanbot.io/developer/ios-barcode-scanner/).
